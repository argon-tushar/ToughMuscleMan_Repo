...
public class ScrollSnapRect1 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    private void NextScreen()
    {
        ...
        if (_currentPage == 0)
        {
            FindObjectOfType<HomeManager>().GymBtn.GetComponent<Image>().sprite = FindObjectOfType<HomeManager>().GymBtn1;
            

        }
        else if (_currentPage == 1)
        {
            FindObjectOfType<HomeManager>().GymBtn.GetComponent<Image>().sprite = FindObjectOfType<HomeManager>().GymBtn2;

        }
        else if (_currentPage == 2)
        {
            FindObjectOfType<HomeManager>().GymBtn.GetComponent<Image>().sprite = FindObjectOfType<HomeManager>().GymBtn3;

        }
        else if (_currentPage == 3)
        {
            FindObjectOfType<HomeManager>().GymBtn.GetComponent<Image>().sprite = FindObjectOfType<HomeManager>().GymBtn4;
